...
"*Hooks called prior to running uncrustify. These hooks are called
each and every time uncrustify is run"
:type 'hook
:group 'uncrustify)

(defcustom uncrustify-finish-hooks nil
"*Hooks called after running uncrustify. These hooks are called
each and every time uncrustify is run"
:type 'hook
:group 'uncrustify)
...
(message "running uncrustify to ident")
(interactive)
